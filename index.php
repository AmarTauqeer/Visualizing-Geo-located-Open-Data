		...
		<script type="text/javascript" >
			...
			$(document).ready(function() {
				...
				$("button").click(function() {
					...
					var test = $.get("data.php",{'distr_code': distr_code,'cat':cat,'category':category}, function(data) {
			...
			<tr>
				<td valign="top">
					<div>
						<table>
							<tr>
							<td><div> <select name="districts" id="districts" multiple="multiple" size="14">
							...
							<tr>
							<td><div  name="div_cat" id="div_cat" style="display: none"> <select name="cat" id="cat" size="14" multiple="multiple">
